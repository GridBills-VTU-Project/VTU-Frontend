  ...
  return (
    <div className="w-full">
      ...
      <div className="flex w-full gap-4 mt-6 flex-wrap max-[1100px]:justify-center justify-between">
        ...
        >
          ...
          >
            ...
            <div>
              <p className="font-bold text-2xl ">
                {data?.data.agentCommissionBalance || 0}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#FFFFFF] mt-20 border-2 border-[#AAAAAA] rounded-xl p-4 pb-10 ">
        ...
        <div className="  mt-10 p-2  gap-x-40 gap-y-20 grid grid-cols-3 grid-rows-2 mx-auto max-w-fit max-[1200px]:grid-cols-2 max-[650px]:grid-cols-1">
          <Link
      ...
      <div className="bg-[#FFFFFF] mt-20 border-2 border-[#AAAAAA] rounded-xl p-4 pb-10 h-[800px]">
        ...
        >
          ...
          data?.data.recentTransactions.length > 0 ? (
            ...
            >
              {data?.data.recentTransactions.map(
                (trans: recentTransactions, index: number) => (
                  <li
                    key={index}
